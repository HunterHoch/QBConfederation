        ...
        if (CanOpenApp) {
            if (QB.Phone.Data.currentApplication == null) {
                ...
                if (PressedApplication == "settings") {
                    ...
                    $("#mySerialNumber").text("V" + QB.Phone.Data.PlayerData.metadata["phonedata"].SerialNumber);
...
QB.Phone.Functions.UpdateTime = function(data) {    
    ...
    $("#phone-time").html(" <span style='font-size: 1.1vh;'>" + data.InGameTime.hour + ":" + data.InGameTime.minute + "</span>");
}
